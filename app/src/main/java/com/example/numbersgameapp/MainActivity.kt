...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var recyclervc : RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        clRootNumbersGame = findViewById(R.id.constrait)
        messages = ArrayList()

        recyclervc.adapter = MessageAdapter(this, messages)
        recyclervc.layoutManager = LinearLayoutManager(this)
    ...
    private fun addMessage(){
        ...
        if(msg.isNotEmpty()){
            ...
            recyclervc.adapter?.notifyDataSetChanged()
        }else{
